...
func main() {
	//fmt.Println("Do you wish to add another block?")
	block := new(BlockList)
	block.CreateBlock(24, "Bob to Alice","")
	block.CreateBlock(25, "Crab to Alice","")
	block.CreateBlock(26, "Sob to Alice","")
	//block.CreateBlock(27, "Amif")
	//block.CreateBlock(28, "Amif")
	block.ChangeBlock(25,"Bob to Bob")
